/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f608b19cd7c8ca7e0d8a4fb6f6bd8d67)
// Runtime types generated with workerd@1.20260921.1 2026-09-22 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	DEFAULT_CONFIG: "pref.ini";
	CONFIG: DurableObjectNamespace<import("./worker/index").ConfigStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ConfigStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_CONFIG">> {}
}
